...
# Bot information
SESSION = environ.get('SESSION', 'ㅤᴹᴿܔUηкηoωη么')
API_ID = int(environ.get('API_ID', '24100993'))
API_HASH = environ.get('API_HASH', '22e7ddd8edc0dc58ffa67a57b06a8712')
BOT_TOKEN = environ.get('BOT_TOKEN', "7125024383:AAG0fCYIk5iWnASKB5xuRjFAisiux8E696U")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://ibb.co/KYKLD4R')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6216394886').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002364878273'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002141111035').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '100232569256')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/INFINIX_4K')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/INFINIX_4K') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/abdul_editor')
